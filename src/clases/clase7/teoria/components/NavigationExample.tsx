...
const NavigationExample = () => {
    ...
    const [destination, setDestination] = useState('/clase7/teoria');
        ...
        <div style={{ color: '#212529' }}>
            ...
            <div style={{
                ...
                <div style={{ marginTop: '15px' }}>
                    ...
                    >
                        <option value="/clase7/teoria">Teoría de esta clase</option>
                        <option value="/clase7/practica">Práctica de esta clase</option>
