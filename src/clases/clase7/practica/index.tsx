        ...
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '15px', marginTop: '20px' }}>
                {products.map(product => (
                    <div
                        key={product.id}
                        onClick={() => navigate(`/clase7/practica/product/${product.id}`)}
                        style={{
                            padding: '15px',
            ...
            <div style={{ marginTop: '20px' }}>
                <Link to="/clase7/practica" style={{ color: '#007bff', textDecoration: 'none' }}>
                    ← Volver a Práctica
                </Link>
            </div>
        </div>
    ...
    if (!product) {
        return (
            <div style={{ padding: '20px' }}>
                ...
                <button onClick={() => navigate('/clase7/practica/products')} style={buttonStyle}>
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ marginTop: '20px', display: 'flex', gap: '10px' }}>
                ...
                <button onClick={() => navigate('/clase7/practica/products')} style={{ ...buttonStyle, backgroundColor: '#6c757d' }}>
                    Ver todos los productos
                </button>
            </div>
        </div>
...
const SearchPage = () => {
    ...
    const handleSearch = () => {
        ...
        navigate(`/clase7/practica/search?${params.toString()}`);
    };
...
const Clase7Practica = () => {
    return (
        <div style={{ padding: '20px' }}>
            <h2>Tienda de práctica</h2>
